...
if(isset($_POST['clearAzure'])) {

    $deleteUrl = "http://localhost/deleteAllAzure.php"; 
                ...
                <header class="page-header">
                    ...
                    <div class="right-wrapper pull-right rightMargin">
                        <ol class="breadcrumbs">
                            ...
                            <li><span>Azure Database</span></li>
                        </ol>
                    </div>
                </header>
                ...
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title">Azure Database</h2>
                        </header>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-none">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
$getAzureDbData = "SELECT * FROM sensor_info";  
$query = mysqli_query($azure_connection, $getAzureDbData);
...
if($query){
	...
	if($count == 0){
		echo "<tr><td></td>";
		echo "<td>No Record In Azure Database!</td>";
                            ...
                            <form class="loginFrom" method="post">
                                <div class="col-md-12">
                                    <div class="form-group loginButton">
                                        <input type="submit" name="clearAzure" value="Clear Azure DB"
